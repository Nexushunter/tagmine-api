...
class ContentApi {
  ...
  Future<Response<void>> contentIdDelete({ 
    ...
    final _path = r'/content/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [id] - ID of content
  /// * [removedTags] - One or more removed tag IDs
  /// * [removedCommunity] - One or more removed community IDs
  /// * [addedTags] - One or more added tag IDs
  /// * [addedCommunity] - One or more added community IDs
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> contentIdPut({ 
    ...
    BuiltList<int>? addedTags,
    BuiltList<int>? addedCommunity,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [id] - ID of content
  /// * [communityId] - ID of community
  /// * [reactionType] - ID of reaction type
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> contentIdReactDelete({ 
    required int id,
    ...
    final _path = r'/content/{id}/react'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> contentIdReactPost({ 
    required int id,
    required String communityId,
    required String reactionType,
    CancelToken? cancelToken,
  ...
  /// * [url] - URL of post
  /// * [thumbnail] - Thumbnail of post
  /// * [tags] - One or more tag IDs
  /// * [community] - One or more community IDs
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
